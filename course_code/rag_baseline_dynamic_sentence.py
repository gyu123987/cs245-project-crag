...
CONTEXT_SENTENCE_THRESHOLD = 0.55
CONTEXT_SENTENCE_DECAY = 0.15
...
class RAGModel:
    ...
    def batch_generate_answer(self, batch: Dict[str, Any]) -> List[str]:
        ...
        for _idx, interaction_id in enumerate(batch_interaction_ids):
            ...
            valid_scores = sorted_scores[sorted_scores >= CONTEXT_SENTENCE_THRESHOLD]
            # Check if there is a drop
            num_context_sentences = len(valid_scores)
            for idx in range(1, len(valid_scores)):
                if valid_scores[idx - 1] - valid_scores[idx] > CONTEXT_SENTENCE_DECAY:
                    num_context_sentences = idx
                    break
    ...
    def format_prompts(self, queries, query_times, batch_retrieval_results=[]):
        ...
        for _idx, query in enumerate(queries):
            ...
            if len(retrieval_results) > 0:
                ...
                references += " References \n No References found, please respond 'I don't know' \n"
